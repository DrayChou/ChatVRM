...
- 中日英の多言語翻訳のサポートを追加
- SiliconCloudのTTSサービスを使用して中国語の音声サポートを追加
- OpenAIプロトコルに対応したAIサービスプロバイダーのサポートを追加
...
ChatVRMでは中国語の返答文の音声読み上げにSiliconCloudのTTS APIを使用しています。

SiliconCloud TTS APIの仕様や利用規約については以下のリンクや公式サイトをご確認ください。
